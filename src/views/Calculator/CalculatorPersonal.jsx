    ...
    <>
      <div className="calculator-splash">
        ...
        <AppPanel header="Instructions" toggleable>
          ...
          start date in the “Start Date” Field and your end date in the “End
          Date Field”. Since service is cumulative, please add additional rows
          in order to account for any breaks in service. Enter each group of
          continuous years on separate lines. For example: If you have been
          working with no breaks in service since 2008, enter “2008” as your
          start year and the current calendar year as your end year. If you
          worked from 2008 to 2010, had a two year break in service and then
          resumed service in 2012, enter “2008” as the start year and “2010” as
          the end year. Then move to the next row and enter “2012” as the start
          year and current calendar year as the end year.
        </AppPanel>
